...
export const adminService = {
  ...
  sendNotification: (clientId, title, message, sendEmail = false) => request(`/admin/clients/${clientId}/notify`, { method: 'POST', body: JSON.stringify({ title, message, send_email: sendEmail }) }),
